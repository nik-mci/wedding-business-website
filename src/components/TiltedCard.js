...
export const TiltedCard = ({
  ...
  return (
    ...
    >
      ...
      {showTooltip && (
        <motion.figcaption
          className="pointer-events-none absolute left-0 top-0 rounded-[4px] bg-[#1A1408] border border-[#C9A234]/30 px-[12px] py-[6px] text-[9px] tracking-[0.2em] uppercase text-[#C9A234] shadow-xl opacity-0 z-[10] hidden sm:block whitespace-nowrap backdrop-blur-md"
          style={{
            x,
            y,
            opacity,
