...
const CC_RECIPIENTS = [
  { address: "arunima.sethi@vowsandvedas.com",  displayName: "Arunima Sethi" },
...
export async function POST(req) {
  ...
  const { firstName, lastName, email, phone, destination, weddingDate, message, chatbotContext, sourcePagePath, referrerUrl } = body ?? {};
